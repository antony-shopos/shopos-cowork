export default function Shift() {
  return (
    <section className="relative w-full py-32 md:py-40 overflow-hidden bg-[#171717] text-white flex items-center justify-center">
      ...
      <div className="relative z-10 max-w-4xl text-center px-6">
        ...
        <p className="text-lg md:text-xl text-white/70 leading-relaxed max-w-3xl mx-auto">
          A swarm of AI agents. They work 24/7, learn from feedback &
